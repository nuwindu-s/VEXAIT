          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-2.5 text-xs text-slate-400">
              ...
              <p className="flex items-center gap-2">
                ...
                <a href="tel:+94712696668" className="hover:text-white transition-colors">
                  {companyData.phone}
                </a>
              </p>
              <p className="flex items-center gap-2">
                ...
                <a href={companyData.whatsappUrl} target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors">
                  WhatsApp: 071 269 6668
                </a>
              </p>
